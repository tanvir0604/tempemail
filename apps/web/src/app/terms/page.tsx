  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8">
      <div className="text-center space-y-4">
        ...
        <h1 className="text-4xl font-bold text-zinc-100">Terms of Service</h1>
      ...
      <div className="prose prose-invert max-w-none space-y-8">
        <section className="space-y-4">
          ...
          <p className="text-zinc-300 leading-relaxed">
            By accessing and using TempEmail's services, you accept and agree to
        ...
        <section className="space-y-4">
          ...
          <p className="text-zinc-300 leading-relaxed">
            TempEmail provides temporary, disposable email addresses for
            receiving emails. These email addresses are temporary by nature and
            may expire after a certain period. We reserve the right to modify,
        ...
        <section className="space-y-4">
          ...
          <p className="text-zinc-300 leading-relaxed mb-4">
            You agree to use TempEmail only for lawful purposes. You may not use
            our service to:
          </p>
        ...
        <section className="space-y-4">
          ...
          <p className="text-zinc-300 leading-relaxed">
            Temporary email addresses and received emails are automatically
            deleted after expiration. We do not permanently store email content
            or associate temporary addresses with user identities. Please refer
        ...
        <section className="space-y-4">
          ...
          <p className="text-zinc-300 leading-relaxed">
            TempEmail is provided "as is" without any warranties, express or
        ...
        <section className="space-y-4">
          ...
          <p className="text-zinc-300 leading-relaxed">
            TempEmail shall not be liable for any indirect, incidental, special,
            consequential, or punitive damages resulting from your use or
            inability to use the service, including but not limited to lost
            data, lost profits, or service interruptions.
          </p>
        </section>
